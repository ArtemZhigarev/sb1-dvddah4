...
import { Home, User, Settings, Search, Package, ShoppingBag, Bug, Users, Building2, Ticket } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/coupons" className="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100">
